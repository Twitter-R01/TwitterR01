...
if __name__ == '__main__':
	# edit settings
	file_i = '/home/pmo14/projects/TwitterR01/AnnotationProjects/classification/data/D3.tsv'
	dataframe = pd.read_table(file_i)
	col = ['tweetID', 'text', 'pro_vape']
	df = dataframe[col]
	x = df.text
	y = df.pro_vape
	embedding = "vape" # set to vape for vape specific embeddings, glove for glove embeddings
	if embedding == "vape":
